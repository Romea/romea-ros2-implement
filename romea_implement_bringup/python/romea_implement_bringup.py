...
class ImplementMetaDescription:
    def __init__(self, meta_description_file_path):
        self.meta_description = MetaDescription("implement", meta_description_file_path)
...
def get_control_configuration_file_path(
    ...
    if "configuration" in control_meta_description:
        ...
        return get_file_path(
            {"pkg": "romea_hitch_bringup", "file": default_configuration_file}
        )
...
def implement_prefix(robot_namespace, meta_description):
    return device_prefix(
        robot_namespace, meta_description.get_namespace(), meta_description.get_name()
    )


def implement_urdf_prefix(robot_namespace, meta_description):
...
def get_controllers_configuration(
    ...
    urdf_prefix = implement_urdf_prefix(robot_namespace, meta_description)
    ...
    ros_prefix = implement_prefix(robot_namespace, meta_description)
...
def urdf_description(robot_namespace, mode, meta_description_file_path):
    ...
    return romea_implement_description.hitch_implement_urdf(
